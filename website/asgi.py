...
# ─── ASGI application ─────────────────────────────────────────────────────────
# On Windows, uvicorn uses a spawned subprocess model. The ASGI app must be
# importable at module level without side effects — this file is safe as-is
# since get_asgi_application() is idempotent.
